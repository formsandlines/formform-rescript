...
import * as Expr from "../src/core/form/Expr.bs.js";
...
Zora.test("Testing FCON.toFVAR", (function (t) {
        exprsCon$1.forEach(function (expr) {
              t.test("given an [FCON] expression", (function (t) {
                      var input = expr.f;
...
Zora.test("Testing FVAR.getVars()", (function (t) {
        exprsVar$1.forEach(function (expr) {
              t.test("given an [FVAR] expression", (function (t) {
                      var input = expr.f;
...
Zora.test("Testing FVAR.countVars()", (function (t) {
        exprsVar$1.forEach(function (expr) {
              t.test("given an [FVAR] expression", (function (t) {
                      var input = expr.f;
                      var actual = Expr.FVAR.countVars(input);
