...
import * as SeqRE$Formform from "../src/core/calc/SeqRE.bs.js";
        ...
        seqREV1.forEach(function (input) {
              t.test("given value space for " + input.f, (function (t) {
                      var actual = valSpc1.map(function (a) {
                            return SeqRE$Formform.calcRE(input.sign, {
                                        NAME: "NestToR",
                                        VAL: {
                                          hd: a,
                                          tl: /* [] */0
...
Zora.test("Testing empty list cases", (function (t) {
        seqRE_empty.forEach(function (param) {
              ...
              t.test("given empty list", (function (t) {
                      var actual = SeqRE$Formform.calcRE(sign, {
                            NAME: "NestToR",
                            VAL: /* [] */0
                          });
                      t.equal(actual, result, "should be " + Calc$Formform.Const.showAsKey(result));
...
Zora.test("Testing UCalc.calc with >= 4 vals and some edge cases", (function (t) {
        t.test("given arbitrary nested values", (function (t) {
                var actual = SeqRE$Formform.calcRE({
                      reEntryPar: /* Odd */1,
                      unmarked: false,
                      interpr: /* RecInstr */0
                    }, {
                ...
                t.equal(actual, /* U */1, "should be " + Calc$Formform.Const.showAsKey(/* U */1));
        ...
        t.test("given arbitrary nested values", (function (t) {
                ...
                t.equal(actual, /* I */2, "should be " + Calc$Formform.Const.showAsKey(/* I */2));
