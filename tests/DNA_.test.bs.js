...
import * as DNA from "../src/core/calc/DNA.bs.js";
...
var dnaV1_01_nuim = DNA.makeUnsafe([
      /* M */3,
      /* U */1,
      /* U */1,
      /* I */2
...
var dnaV1_01_nmui = DNA.makeUnsafe([
      /* U */1,
      /* U */1,
      /* M */3,
      /* I */2
...
var dnaV2_01_nuim = DNA.makeUnsafe([
      /* N */0,
      /* U */1,
      /* I */2,
      /* M */3,
...
var dnaV2_01_nmui = DNA.makeUnsafe([
      /* N */0,
      /* I */2,
      /* N */0,
      /* I */2,
...
var dnaV3_01_nuim = DNA.makeUnsafe([
      /* N */0,
      /* U */1,
      /* I */2,
      /* M */3,
...
var dnaV3_01_nmui = DNA.makeUnsafe([
      /* I */2,
      /* M */3,
      /* U */1,
      /* M */3,
...
Zora$1.test("Testing isValidLength()", (function (t) {
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(-4);
                t.notOk(test, "should be power of 4");
                
              }));
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(0);
                t.notOk(test, "should be power of 4");
                
              }));
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(1);
        ...
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(8);
                t.notOk(test, "should be power of 4");
                
              }));
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(16);
                t.ok(test, "should be power of 4");
                
              }));
        t.test("given a length as int", (function (t) {
                var test = DNA.isValidLength(64);
                t.ok(test, "should be power of 4");
...
Zora$1.test("Testing reorderToNMUI()", (function (t) {
        t.test("given dna of single value", (function (t) {
                var input = DNA.makeUnsafe([/* U */1]);
                var actual = DNA.reorderToNMUI(input);
                var expected = DNA.makeUnsafe([/* U */1]);
...
Zora$1.test("Testing fromIntArr()", (function (t) {
        t.test("given empty array", (function (t) {
                var input = [];
                var actual = DNA.fromIntArr(undefined, input);
        ...
        t.test("given dna of " + "((a)b)" + " as ints in NMUI ordering", (function (t) {
                ...
                var actual = DNA.fromIntArr(true, input);
                var expected = dnaV2_01_nmui;
                t.equal(actual, expected, "should be dna of " + "((a)b)" + " in NMUI ordering");
...
Zora$1.test("Testing fromStrArr()", (function (t) {
        t.test("given empty array", (function (t) {
                var input = [];
                var actual = DNA.fromStrArr(input);
                return Zora.optionNone(t, actual, "should be None");
              }));
        t.test("given dna of single value", (function (t) {
                var input = [""];
                var actual = DNA.fromStrArr(input);
                var expected = DNA.makeUnsafe([/* N */0]);
...
Zora$1.test("Testing show()", (function (t) {
        t.test("given dna of single value", (function (t) {
                var input = DNA.makeUnsafe([/* U */1]);
                var actual = DNA.show(undefined, undefined, input);
                var expected = "⁘1";
        ...
        t.test("given dna of " + "((a)b)", (function (t) {
                var input = dnaV2_01_nuim;
                var actual = DNA.show(true, true, input);
        ...
        t.test("given dna of " + "{@ a,b,c}{@ b,c,a}{@ a,c,b}", (function (t) {
                var input = dnaV3_01_nuim;
                var actual = DNA.show(undefined, true, input);
...
Zora$1.test("Testing inv()", (function (t) {
        t.test("given dna of single value", (function (t) {
                var input = DNA.makeUnsafe([/* U */1]);
                var actual = DNA.inv(input);
                var expected = DNA.makeUnsafe([/* I */2]);
...
Zora$1.test("Testing rel()", (function (t) {
        t.test("given 2 equal singleton dnas", (function (t) {
                var input_a = DNA.makeUnsafe([/* N */0]);
                var input_b = DNA.makeUnsafe([/* N */0]);
                var actual = DNA.rel(input_a, input_b);
                var expected = DNA.makeUnsafe([/* N */0]);
                t.equal(actual, expected, "should be same as either input");
                
              }));
        t.test("given 2 different singleton dnas", (function (t) {
                var input_a = DNA.makeUnsafe([/* I */2]);
                var input_b = DNA.makeUnsafe([/* U */1]);
                var actual = DNA.rel(input_a, input_b);
                var expected = DNA.makeUnsafe([/* M */3]);
                t.equal(actual, expected, "should be M");
                
              }));
        t.test("given a singleton and a larger dna", (function (t) {
                var input_a = DNA.makeUnsafe([/* I */2]);
                var input_b = DNA.makeUnsafe([
                      /* U */1,
                      /* N */0,
                      /* M */3,
                      /* N */0
