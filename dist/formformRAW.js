...
/* harmony export */ });
/* harmony import */ var _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calc.bs.js */ "./src/core/calc/Calc.bs.js");
/* harmony import */ var _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/Helper.bs.js */ "./src/utils/Helper.bs.js");
...
/* harmony import */ var rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rescript/lib/es6/belt_Array.js */ "./node_modules/rescript/lib/es6/belt_Array.js");
// Generated by ReScript, PLEASE EDIT WITH CARE
...
function getSizeFromLength(len) {
  ...
  if (!Number.isFinite(x) || _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__.hasDecimal(x)) {
    return ;
  } else {
    return x | 0;
  }
...
function reorderToNMUI(dna) {
  ...
  var partLen = len / 4 | 0;
  return rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__.concatMany(rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__.makeBy(4, (function (i) {
                    var i_nmui;
                    switch (i) {
                      case 0 :
                          i_nmui = 1;
...
function fromIntArr(sortNMUIOpt, arr) {
  ...
  if (isValidLength(arr.length) === false) {
    ...
    return arr.map(function (n) {
                var c = _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.fromInt(sortNMUI, n);
                if (c !== undefined) {
                  return c;
                }
                throw {
...
function fromStrArr(arr) {
  if (isValidLength(arr.length) === false) {
    ...
    return arr.map(function (n) {
                var c = _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.tFromStr(n);
                if (c !== undefined) {
                  return c;
                }
                throw {
...
function show(sortNMUIOpt, spacedOpt, dna) {
  ...
  if (rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_2__.caml_equal(dna_sorted, [])) {
    return prefix + _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.toInt(sortNMUI, /* N */0).toString();
  } else {
    return prefix + dna_sorted.reduce((function (str, c, i) {
                  var spc = spaced && i > 0 && i % 4 === 0 ? " " : "";
                  return str + spc + _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.toInt(sortNMUI, c).toString();
                }), "");
  }
}

function raw(dna) {
  if (rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_2__.caml_equal(dna, [])) {
    return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.showAsKey(/* N */0);
  } else {
    return dna.map(function (c) {
                  return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.showAsKey(c);
                }).join("");
  }
}
...
function inv(dna) {
  if (rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_2__.caml_equal(dna, [])) {
    return [_Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.inv(/* N */0)];
  } else {
    return dna.map(function (c) {
                return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.inv(c);
              });
  }
}
...
function rel(dna_a, dna_b) {
  ...
  var subLen = match[2];
  var sup = match[1];
  var result = rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__.zipBy(sup, match[0], (function (a, b) {
          return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.rel(a, b);
        }));
  if (subLen === supLen) {
    return result;
  } else {
    return rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__.concat(result, rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_3__.slice(sup, subLen, supLen));
  }
}
...
/* harmony import */ var _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calc.bs.js */ "./src/core/calc/Calc.bs.js");
/* harmony import */ var _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/Helper.bs.js */ "./src/utils/Helper.bs.js");
/* harmony import */ var rescript_lib_es6_js_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rescript/lib/es6/js_list.js */ "./node_modules/rescript/lib/es6/js_list.js");
...
function calcRE(param, param$1) {
  ...
  var resPar = nestedC === /* [] */0 || rescript_lib_es6_js_list_js__WEBPACK_IMPORTED_MODULE_2__.length(nestedC) % 2 !== 0 ? /* Odd */1 : /* Even */0;
  var reType = getUType({
        reEntryPar: reEntryPar,
        unmarked: unmarked,
        interpr: interpr
      }, resPar);
  if (nestedC === /* [] */0 || rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_4__.every(nestedC, (function (c) {
            return c === /* N */0;
          }))) {
    if (reType) {
      return /* I */2;
  ...
  var nestedC$1 = !unmarked && resPar === /* Odd */1 && reEntryPar === /* Even */0 ? rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_4__.concat(nestedC, nestedC) : nestedC;
  if (rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_4__.some(nestedC$1, (function (c) {
            return c === /* M */3;
          })) || rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_4__.some(nestedC$1, (function (c) {
            return c === /* U */1;
          })) && rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_4__.some(nestedC$1, (function (c) {
            return c === /* I */2;
          }))) {
    var r = _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Nested.calcR(_Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Nested.reduceR({
              NAME: "NestToR",
              VAL: nestedC$1
            }));
    if (unmarked) {
      return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.inv(r);
    } else {
      return r;
    }
  }
  var match = _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Nested.reduceR({
        NAME: "NestToR",
        VAL: nestedC$1
      });
  var nestedC$2 = match.VAL;
  var bottom_c = rescript_lib_es6_js_list_js__WEBPACK_IMPORTED_MODULE_2__.hd(nestedC$2);
  if (interpr === /* RecIdent */1 && !unmarked && rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_3__.caml_equal(bottom_c, /* N */0)) {
    if (nestedC$2) {
      var match$1 = nestedC$2.tl;
      if (match$1) {
        var c = match$1.hd;
        if (reType) {
          return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.rel(/* I */2, c);
        } else {
          return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.rel(/* U */1, c);
        }
      }
      throw {
            RE_EXN_ID: _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__.Unreachable,
            Error: new Error()
          };
    }
    throw {
  ...
  if (interpr === /* RecIdent */1 && unmarked && rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_3__.caml_notequal(bottom_c, /* N */0)) {
    if (bottom_c !== undefined) {
      if (reType) {
        return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.rel(/* I */2, bottom_c);
      } else {
        return _Calc_bs_js__WEBPACK_IMPORTED_MODULE_0__.Const.rel(/* U */1, bottom_c);
      }
    }
    throw {
          RE_EXN_ID: _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__.Unreachable,
...
/* harmony export */ });
/* harmony import */ var _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../calc/DNA.bs.js */ "./src/core/calc/DNA.bs.js");
/* harmony import */ var _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../calc/Calc.bs.js */ "./src/core/calc/Calc.bs.js");
...
/* harmony import */ var _calc_SeqRE_bs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../calc/SeqRE.bs.js */ "./src/core/calc/SeqRE.bs.js");
...
/* harmony import */ var rescript_lib_es6_belt_Id_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rescript/lib/es6/belt_Id.js */ "./node_modules/rescript/lib/es6/belt_Id.js");
/* harmony import */ var rescript_lib_es6_belt_Set_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rescript/lib/es6/belt_Set.js */ "./node_modules/rescript/lib/es6/belt_Set.js");
/* harmony import */ var rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rescript/lib/es6/caml_obj.js */ "./node_modules/rescript/lib/es6/caml_obj.js");
/* harmony import */ var rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rescript/lib/es6/belt_List.js */ "./node_modules/rescript/lib/es6/belt_List.js");
...
function showForm(sortNMUIOpt, form) {
  ...
  switch (form.TAG | 0) {
    ...
    case /* CVal */1 :
        return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.show(form._0);
    case /* SeqRE */2 :
        return "{" + showSeq(sortNMUI, form._1) + " " + _calc_SeqRE_bs_js__WEBPACK_IMPORTED_MODULE_3__.showSig(form._0) + "}";
    case /* Uncl */3 :
        var lbl = form._0;
        return "/" + _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_4__.cleanStr(lbl) + "/";
    case /* Var */4 :
        var lbl$1 = form._0;
        if (lbl$1.length === 1) {
          return _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_4__.cleanStr(lbl$1);
        } else {
          return "\"" + _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_4__.cleanStr(lbl$1) + "\"";
        }
    case /* FDna */5 :
...
function showSeq(sortNMUIOpt, seq) {
  var sortNMUI = sortNMUIOpt !== undefined ? sortNMUIOpt : false;
  return _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_4__.ListExtensions.joinWith(rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.map(seq, (function (expr) {
...
function showFdna($staropt$star, param) {
  ...
  return formStr + _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__.show(sortNMUI, undefined, param.dna);
}

function reduceExpr(reducerFn, init, expr) {
  return rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_9__.reduce(expr, init, (function (param, param$1) {
                var acc = rescript_lib_es6_curry_js__WEBPACK_IMPORTED_MODULE_2__._2(reducerFn, param, param$1);
                switch (param$1.TAG | 0) {
                  case /* Mark */0 :
                      return reduceExpr(reducerFn, acc, param$1._0);
                  case /* SeqRE */2 :
                      var seq = param$1._1;
                      return rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.reduce(seq, acc, (function (param, param$1) {
  ...
  switch (form.TAG | 0) {
    ...
    case /* SeqRE */2 :
        return {
                TAG: /* SeqRE */2,
                _0: form._0,
                _1: rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.map(form._1, (function (expr) {
...
function getVars(expr) {
  var cmp = rescript_lib_es6_caml_obj_js__WEBPACK_IMPORTED_MODULE_7__.caml_compare;
  var VarCmp = rescript_lib_es6_belt_Id_js__WEBPACK_IMPORTED_MODULE_5__.MakeComparable({
        cmp: cmp
      });
  var _getVars = function (vars, form) {
    if (form.TAG === /* Var */4) {
      return rescript_lib_es6_belt_Set_js__WEBPACK_IMPORTED_MODULE_6__.add(vars, form._0);
    } else {
      return vars;
    }
  };
  var init = rescript_lib_es6_belt_Set_js__WEBPACK_IMPORTED_MODULE_6__.make(VarCmp);
  return rescript_lib_es6_belt_Set_js__WEBPACK_IMPORTED_MODULE_6__.toArray(reduceExpr$1(_getVars, init, expr));
}
...
function toFORMt(seq) {
  ...
  if (seq$p) {
    return {
            TAG: /* Mark */0,
            _0: rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_9__.concat(expr, [toFORMt(seq$p)])
          };
  } else {
    return {
            TAG: /* Mark */0,
...
/* harmony import */ var _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../calc/Calc.bs.js */ "./src/core/calc/Calc.bs.js");
/* harmony import */ var rescript_lib_es6_curry_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rescript/lib/es6/curry.js */ "./node_modules/rescript/lib/es6/curry.js");
/* harmony import */ var _utils_JsRaw_bs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/JsRaw.bs.js */ "./src/utils/JsRaw.bs.js");
/* harmony import */ var _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/Helper.bs.js */ "./src/utils/Helper.bs.js");
/* harmony import */ var rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rescript/lib/es6/js_dict.js */ "./node_modules/rescript/lib/es6/js_dict.js");
/* harmony import */ var rescript_lib_es6_js_math_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rescript/lib/es6/js_math.js */ "./node_modules/rescript/lib/es6/js_math.js");
/* harmony import */ var rescript_lib_es6_belt_Int_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rescript/lib/es6/belt_Int.js */ "./node_modules/rescript/lib/es6/belt_Int.js");
/* harmony import */ var rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rescript/lib/es6/belt_List.js */ "./node_modules/rescript/lib/es6/belt_List.js");
/* harmony import */ var rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rescript/lib/es6/belt_Array.js */ "./node_modules/rescript/lib/es6/belt_Array.js");
// Generated by ReScript, PLEASE EDIT WITH CARE
...
function show(vp) {
  return "[" + rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.toArray(rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.map(vp, (function (c) {
                      return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.show(c);
                    }))).join(",") + "]";
}

function showAsKey(vp) {
  return rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.toArray(rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.map(vp, (function (c) {
                      return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.showAsKey(c);
                    }))).join("");
}
...
function tFromStr(sortNMUIOpt, str) {
  ...
  var maybe_vpoint = str.split("").map(function (val) {
        var n = rescript_lib_es6_belt_Int_js__WEBPACK_IMPORTED_MODULE_7__.fromString(val);
        if (n !== undefined) {
          return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.fromInt(sortNMUI, n);
        } else {
          return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.tFromStr(val);
        }
      });
  if (maybe_vpoint.every(function (v) {
          return v !== undefined;
        })) {
    return rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_8__.fromArray(maybe_vpoint.map(function (v) {
                    return v;
                  }));
  }
...
function make(sortNMUIOpt, dim) {
  var sortNMUI = sortNMUIOpt !== undefined ? sortNMUIOpt : false;
  var resolution = rescript_lib_es6_js_math_js__WEBPACK_IMPORTED_MODULE_6__.floor_int(Math.pow(4.0, dim));
  return rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_9__.makeBy(resolution, (function (i) {
                var vp_str = _utils_JsRaw_bs_js__WEBPACK_IMPORTED_MODULE_3__.padStart(i.toString(4), dim, "0");
...
function toDNA(vspc, map) {
  return _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__.makeUnsafe(vspc.map(rescript_lib_es6_curry_js__WEBPACK_IMPORTED_MODULE_2__.__1(map)).reverse());
}
...
function makeFromDNA(dna) {
  var dnaArr = _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__.toArray(dna);
  var len = Math.log(dnaArr.length) / Math.log(4.0);
  var vspc = make(undefined, rescript_lib_es6_js_math_js__WEBPACK_IMPORTED_MODULE_6__.floor_int(len));
  return rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__.fromArray(rescript_lib_es6_belt_Array_js__WEBPACK_IMPORTED_MODULE_9__.zipBy(vspc, dnaArr.reverse(), (function (vp, result) {
                    return [
                            showAsKey(vp),
                            result
                          ];
...
/* harmony import */ var rescript_lib_es6_curry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rescript/lib/es6/curry.js */ "./node_modules/rescript/lib/es6/curry.js");
/* harmony import */ var _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/Helper.bs.js */ "./src/utils/Helper.bs.js");
/* harmony import */ var rescript_lib_es6_js_exn_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rescript/lib/es6/js_exn.js */ "./node_modules/rescript/lib/es6/js_exn.js");
/* harmony import */ var rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rescript/lib/es6/belt_List.js */ "./node_modules/rescript/lib/es6/belt_List.js");
/* harmony import */ var rescript_lib_es6_caml_array_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rescript/lib/es6/caml_array.js */ "./node_modules/rescript/lib/es6/caml_array.js");
// Generated by ReScript, PLEASE EDIT WITH CARE
...
function fromVPoint(varsOpt, vp) {
  var vars = varsOpt !== undefined ? varsOpt : _utils_Helper_bs_js__WEBPACK_IMPORTED_MODULE_1__.common_vars;
  if (vars.length < rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_3__.length(vp)) {
    throw rescript_lib_es6_js_exn_js__WEBPACK_IMPORTED_MODULE_2__.raiseRangeError("Insufficient variables in given list!");
  }
  return {
          TAG: /* Mark */0,
          _0: rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_3__.toArray(rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_3__.mapWithIndex(vp, (function (i, c) {
                      return {
                              TAG: /* Mark */0,
                              _0: [get(c, rescript_lib_es6_caml_array_js__WEBPACK_IMPORTED_MODULE_4__.get(vars, i))]
                            };
                    })))
        };
}
...
/* harmony import */ var _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../calc/DNA.bs.js */ "./src/core/calc/DNA.bs.js");
/* harmony import */ var _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../calc/Calc.bs.js */ "./src/core/calc/Calc.bs.js");
/* harmony import */ var _form_Expr_bs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../form/Expr.bs.js */ "./src/core/form/Expr.bs.js");
/* harmony import */ var _calc_SeqRE_bs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../calc/SeqRE.bs.js */ "./src/core/calc/SeqRE.bs.js");
/* harmony import */ var _form_Value_bs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../form/Value.bs.js */ "./src/core/form/Value.bs.js");
/* harmony import */ var rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rescript/lib/es6/js_dict.js */ "./node_modules/rescript/lib/es6/js_dict.js");
/* harmony import */ var rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rescript/lib/es6/belt_List.js */ "./node_modules/rescript/lib/es6/belt_List.js");
...
function toVPoint(interpr) {
  return rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__.fromArray(rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__.values(interpr));
}

function fromVPoint(vp, vars) {
  if (rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__.length(vp) !== vars.length) {
    return ;
  }
  var interpr_arr = rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__.mapWithIndex(vp, (function (i, c) {
          return [
                  vars[i],
                  c
                ];
        }));
  return rescript_lib_es6_caml_option_js__WEBPACK_IMPORTED_MODULE_7__.some(rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__.fromList(interpr_arr));
}
...
function interpretExpr(expr, intpr) {
  return expr.map(function (form) {
              switch (form.TAG | 0) {
                ...
                case /* Var */4 :
                    var maybeVal = rescript_lib_es6_js_dict_js__WEBPACK_IMPORTED_MODULE_5__.get(intpr, form._0);
...
function interpretSeq(seq, intpr) {
  return rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__.map(seq, (function (expr) {
...
function evalForm(form) {
  switch (form.TAG | 0) {
    case /* Mark */0 :
        var expr = form._0;
        if (expr.length !== 0) {
          return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.inv(evalExpr(expr));
        } else {
          return /* M */3;
        }
    case /* CVal */1 :
        return form._0;
    case /* SeqRE */2 :
        return _calc_SeqRE_bs_js__WEBPACK_IMPORTED_MODULE_3__.calcRE(form._0, nestedEval(form._1));
    case /* Uncl */3 :
        return /* U */1;
    case /* FDna */5 :
        return /* N */0;
...
function evalExpr(expr) {
  return expr.reduce((function (val, form) {
                return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.rel(val, evalForm(form));
              }), /* N */0);
}
...
function nestedEval(seq) {
  return {
          NAME: "NestToR",
          VAL: rescript_lib_es6_belt_List_js__WEBPACK_IMPORTED_MODULE_6__.map(seq, evalExpr)
        };
}
...
function evalSeq(seq) {
  ...
  var expr = seq.hd;
  if (seq$p) {
    return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.inv(_calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.rel(evalExpr(expr), evalSeq(seq$p)));
  } else {
    return _calc_Calc_bs_js__WEBPACK_IMPORTED_MODULE_1__.Const.inv(evalExpr(expr));
  }
}
...
function evalAll(expr) {
  var vars = _form_Expr_bs_js__WEBPACK_IMPORTED_MODULE_2__.FVAR.getVars(expr);
  var vnum = vars.length;
  var vspace = _form_Value_bs_js__WEBPACK_IMPORTED_MODULE_4__.VSpace.make(undefined, vnum);
  var dna = _calc_DNA_bs_js__WEBPACK_IMPORTED_MODULE_0__.makeUnsafe(_form_Value_bs_js__WEBPACK_IMPORTED_MODULE_4__.VSpace.toArray(vspace).map(function (vpoint) {
              var interpr = fromVPoint(vpoint, vars);
              if (interpr !== undefined) {
                return evalExpr(interpretExpr(expr, rescript_lib_es6_caml_option_js__WEBPACK_IMPORTED_MODULE_7__.valFromOption(interpr)));
              }
              throw {
                    RE_EXN_ID: "Not_found",
                    Error: new Error()
...
var Unreachable = /* @__PURE__ */rescript_lib_es6_caml_exceptions_js__WEBPACK_IMPORTED_MODULE_2__.create("Helper.Unreachable");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,